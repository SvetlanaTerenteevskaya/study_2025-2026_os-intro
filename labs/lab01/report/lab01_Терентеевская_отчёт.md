...
- [<span class="toc-section-number">4</span> Выполнение лабораторной
  ...
  - [<span class="toc-section-number">4.1</span> Установка операционной
    системы](#установка-операционной-системы)
  - [<span class="toc-section-number">4.2</span> После
    установки](#после-установки)
  - [<span class="toc-section-number">4.3</span> Настройка раскладки
    клавиатуры](#настройка-раскладки-клавиатуры)
  - [<span class="toc-section-number">4.4</span> Установка имени
    пользователя и названия
    хоста](#установка-имени-пользователя-и-названия-хоста)
  - [<span class="toc-section-number">4.5</span> Установка программного
    обеспечения для создания
    документации](#установка-программного-обеспечения-для-создания-документации)
  - [<span class="toc-section-number">4.6</span> Домашнее
...
<img src="image/4.png" style="width:100.0%" />
...
<img src="image/5.png" style="width:100.0%" />
...
<img src="image/6.png" style="width:100.0%" />
...
<img src="image/7.png" style="width:100.0%" />

Рисунок 7: Установка программ

</div>

В файле /etc/selinux/cjnfig я заменила значение SELINUX
(<a href="#fig-008" class="quarto-xref">рис. 8</a>).

<div id="fig-008">

<img src="image/8.png" style="width:100.0%" />
...
<img src="image/9.png" style="width:100.0%" />
...
<img src="image/10.png" style="width:100.0%" />
...
<img src="image/11.png" style="width:100.0%" />
...
<img src="image/12.png" style="width:100.0%" />
...
<img src="image/13.png" style="width:100.0%" />
...
<img src="image/14.png" style="width:100.0%" />
...
<img src="image/15.png" style="width:100.0%" />
...
<img src="image/16.png" style="width:100.0%" />
...
<img src="image/17.png" style="width:100.0%" />
...
<img src="image/18.png" style="width:100.0%" />
...
<img src="image/19.png" style="width:100.0%" />
...
<img src="image/20.png" style="width:100.0%" />
...
Я приобрела практические навыки установки операционной системы на
...
- [Методичка к лабораторной работе
  №1](https://esystem.rudn.ru/mod/page/view.php?id=1358180)
