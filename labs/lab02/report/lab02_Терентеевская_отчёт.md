...
- [<span class="toc-section-number">4</span> Выполнение лабораторной
  ...
  - [<span class="toc-section-number">4.1</span> Установка програмного
    обеспечения](#установка-програмного-обеспечения)
  - [<span class="toc-section-number">4.2</span> Базовая настройка
    git](#базовая-настройка-git)
  - [<span class="toc-section-number">4.3</span> Создание ключей
    ssh](#создание-ключей-ssh)
  - [<span class="toc-section-number">4.4</span> Создание ключей
    pgp](#создание-ключей-pgp)
  - [<span class="toc-section-number">4.5</span> Настройка
    github](#настройка-github)
  - [<span class="toc-section-number">4.6</span> Добавление PGP ключа в
    GitHub](#добавление-pgp-ключа-в-github)
  - [<span class="toc-section-number">4.7</span> Настройка
    автоматических подписей коммитов
    git](#настройка-автоматических-подписей-коммитов-git)
  - [<span class="toc-section-number">4.8</span> Настройка
    gh](#настройка-gh)
  - [<span class="toc-section-number">4.9</span> Шаблон для рабочего
    пространства](#шаблон-для-рабочего-пространства)
...
<img src="image/2.1.png" style="width:100.0%" />
...
<img src="image/2.2.png" style="width:100.0%" />
...
поле ввода в GitHub (<a href="#fig-007" class="quarto-xref">рис. 7</a>).
